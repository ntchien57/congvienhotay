<div class="sidebar">
    <ul>
        <li name="trochoi"><a href="?role=admin&page=trochoi"><i class="fa fa-mobile"></i>Quản lý trò chơi abc</a></li>
        <li name="taikhoan"><a href="?role=admin&page=taikhoan"><i class="fa fa-bars"></i>Quản lý tài khoản</a></li>
        <li name="hoadon"><a href="?role=admin&page=hoadon"><i class="fa fa-money"></i>Quản lý đơn hàng</a></li>
